...
class AERMODVisualizer:
    ...
    def __init__(self, results):
        ...
        Args:
            results: AERMODResults object from pyaermod_output_parser
        """
...
if __name__ == "__main__":
    ...
    if len(sys.argv) > 1:
        ...
        print("\nUsage:")
        print("  python pyaermod_visualization.py <output_file.out>")
        print("\nOr import and use:")
        print("  from pyaermod_visualization import AERMODVisualizer")
